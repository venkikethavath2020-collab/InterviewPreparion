...
## 1. Overview
- **What this file does**: Currying and partial application for function composition and reusable abstractions.
...
## 2. Core Concept
- **Main concept**: Currying and partial application for function composition and reusable abstractions.
...
|---|---|---|---|---|
| `add` | a, b, c | Context-dependent (example/demo output) | May log to console or mutate local/demo state | Use as a reference pattern and adapt to production utilities/components |
| `curried` | ...args | Context-dependent (example/demo output) | May log to console or mutate local/demo state | Use as a reference pattern and adapt to production utilities/components |
| `curry` | fn | Context-dependent (example/demo output) | May log to console or mutate local/demo state | Use as a reference pattern and adapt to production utilities/components |


## 5. Interview Focus
- **What interviewers expect**: Interviewers check when currying improves API ergonomics vs harming readability.
- **Common questions**:
