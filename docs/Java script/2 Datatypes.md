...
## 1. Overview
- **What this file does**: Primitive vs reference types, dynamic typing, and identity/value semantics.
...
## 2. Core Concept
- **Main concept**: Primitive vs reference types, dynamic typing, and identity/value semantics.
...
|---|---|---|---|---|
| `countVowels` | str | Context-dependent (example/demo output) | May log to console or mutate local/demo state | Use as a reference pattern and adapt to production utilities/components |
| `findVowles` | data | Context-dependent (example/demo output) | May log to console or mutate local/demo state | Use as a reference pattern and adapt to production utilities/components |
| `greet` | - | Context-dependent (example/demo output) | May log to console or mutate local/demo state | Use as a reference pattern and adapt to production utilities/components |
| `movezerotoend` | - | Context-dependent (example/demo output) | May log to console or mutate local/demo state | Use as a reference pattern and adapt to production utilities/components |


## 5. Interview Focus
- **What interviewers expect**: Interviewers focus on coercion, equality behavior, and memory model implications.
- **Common questions**:
