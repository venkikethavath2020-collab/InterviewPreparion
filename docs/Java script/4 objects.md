...
## 1. Overview
- **What this file does**: Object modeling, property access, mutation patterns, and object composition.
...
## 2. Core Concept
- **Main concept**: Object modeling, property access, mutation patterns, and object composition.
...
## 5. Interview Focus
- **What interviewers expect**: Interviewers test object copying, identity pitfalls, and API design choices.
- **Common questions**:
