...
## 1. Overview
- **What this file does**: `call`, `apply`, and `bind` for explicit `this` control and function borrowing.
...
## 2. Core Concept
- **Main concept**: `call`, `apply`, and `bind` for explicit `this` control and function borrowing.
...
## 5. Interview Focus
- **What interviewers expect**: Interviewers test invocation differences and partial application patterns.
- **Common questions**:
