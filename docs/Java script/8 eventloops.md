...
## 1. Overview
- **What this file does**: Event loop, call stack, Web APIs, microtask vs macrotask scheduling.
...
## 2. Core Concept
- **Main concept**: Event loop, call stack, Web APIs, microtask vs macrotask scheduling.
- **Internal working**: Promise callbacks queue in microtasks and run before macrotasks like `setTimeout` after current stack is empty.
...
## 5. Interview Focus
- **What interviewers expect**: Interviewers often use output-order puzzles to assess true async understanding.
- **Common questions**:
