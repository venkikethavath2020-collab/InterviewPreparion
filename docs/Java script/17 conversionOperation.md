# 17 conversionOperation

## 1. Overview
- **What this file does**: Type conversion and coercion (`Number`, `String`, `Boolean`, implicit coercion pitfalls).
...
## 2. Core Concept
- **Main concept**: Type conversion and coercion (`Number`, `String`, `Boolean`, implicit coercion pitfalls).
...
## 5. Interview Focus
- **What interviewers expect**: Interviewers ask coercion edge cases and equality behavior.
- **Common questions**:
