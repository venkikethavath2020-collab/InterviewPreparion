...
## 1. Overview
- **What this file does**: Iteration constructs (`for`, `for...of`, helpers like `map/filter/reduce`) and custom polyfill behavior.
...
## 2. Core Concept
- **Main concept**: Iteration constructs (`for`, `for...of`, helpers like `map/filter/reduce`) and custom polyfill behavior.
...
## 5. Interview Focus
- **What interviewers expect**: Interviewers test loop selection trade-offs, short-circuiting, and array helper internals.
- **Common questions**:
