...
## 1. Overview
- **What this file does**: Rest/spread operators for variadic APIs, immutable updates, and structural copying.
...
## 2. Core Concept
- **Main concept**: Rest/spread operators for variadic APIs, immutable updates, and structural copying.
...
|---|---|---|---|---|
| `sum` | ...numbers | Context-dependent (example/demo output) | May log to console or mutate local/demo state | Use as a reference pattern and adapt to production utilities/components |


## 5. Interview Focus
- **What interviewers expect**: Interviewers check shallow-copy caveats and functional update patterns.
- **Common questions**:
